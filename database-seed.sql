...
INSERT IGNORE INTO users (email, password_hash, full_name, phone, role, account_type) VALUES 
  ('admin@darkhedma.com', '$2y$10$rH8pVQPz1K.KhPKJ9LXOj.9YNZhGQ0p0Zq2.gK0x.YdZjGxN3Kj1K', 'Admin User', '+1234567890', 'admin', 'business');

-- Insert test users (password: user123)
INSERT IGNORE INTO users (email, password_hash, full_name, phone, role, account_type, address, city) VALUES 
  ('john@example.com', '$2y$10$rH8pVQPz1K.KhPKJ9LXOj.9YNZhGQ0p0Zq2.gK0x.YdZjGxN3Kj1K', 'John Doe', '+1234567891', 'user', 'individual', '123 Main St', 'Dubai'),
  ('business@example.com', '$2y$10$rH8pVQPz1K.KhPKJ9LXOj.9YNZhGQ0p0Zq2.gK0x.YdZjGxN3Kj1K', 'ABC Company', '+1234567892', 'user', 'business', '456 Business Ave', 'Abu Dhabi');

-- Insert Service Categories
INSERT IGNORE INTO service_categories (name, name_ar, description, icon, display_order) VALUES 
...
-- Insert Services
INSERT IGNORE INTO services (category_id, name, name_ar, description, target_audience, service_type) VALUES 
  -- Cleaning Services
...
INSERT IGNORE INTO service_pricing (service_id, pricing_type, service_mode, duration_type, price, description) VALUES 
...
INSERT IGNORE INTO service_providers (full_name, email, phone, city, skills, experience_years, availability, status) VALUES 
